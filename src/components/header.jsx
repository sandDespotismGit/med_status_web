...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        <HStack spacing={["5px", "10px", "10px", "15px", "20px"]} align="center">
          <Text to="/#">
            <Image
              src={logo}
          ...
          <VStack align="flex-start" spacing={["5px", "10px", "10px", "15px", "20px"]}>
            <Text
              fontWeight={700}
      ...
      >
        ...
        <Text fontSize={["10px", "10px", "14px", "16px", "18px"]}>Отзывы</Text>
        <Text fontSize={["10px", "10px", "14px", "16px", "18px"]}>
          Контакты
        </Text>
        <Text fontSize={["10px", "10px", "14px", "16px", "18px"]}>
